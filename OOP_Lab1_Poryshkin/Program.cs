...
class Program
{
    ...
    static DateTime GetValidatedDate()
    {
        while (true)
        {
            ...
            {
                if (date.Year < 1900)
                    Console.WriteLine("Помилка: Дата не може бути раніше 1900 року.");
                else if (date > DateTime.Now)
                    Console.WriteLine("Помилка: Дата не може бути у майбутньому.");
                else
                    return date;
            }
            else
    ...
    static void ViewAllPlants()
    {
        ...
        Console.WriteLine("\n--- Всі рослини ---");
        Console.WriteLine("{0,-3} {1,-20} {2,-10} {3,-8} {4,-12} {5,-12}",
                          "#", "Назва", "Тип", "Вік", "Висота", "Посаджено");
        for (int i = 0; i < plants.Count; i++)
        {
            var p = plants[i];
            Console.WriteLine("{0,-3} {1,-20} {2,-10} {3,-8} {4,-12:F2} {5,-12:yyyy-MM-dd}",
